...
public class ContinueWatchingRequestDTO {
    ...
    @jakarta.validation.constraints.NotNull(message = "Current time is required")
    private Integer currentTime;

    @Schema(
        description = "Season identifier (required for TV series)",
        example =  "1",
    ...
    @Schema(
        description = "Episode identifier (required for TV series)",
        example = "1",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
